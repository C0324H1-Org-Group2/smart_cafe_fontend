...
//     const [onFilter, setOnFilter] = useState(null); // Added filter for `on`
//
//     const userRole = localStorage.getItem('userRole'); // Lấy quyền từ local storage
//     useEffect(() => {
...
function TableList() {
    ...
    const userRole = JSON.parse(localStorage.getItem('authorities')) || [];
